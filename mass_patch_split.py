...
def parse_args():
    ...
    parser.add_argument("--input-img-dir", default="data/mass_build/png/test")
    parser.add_argument("--input-mask-dir", default="data/mass_build/png/test_labels")
    parser.add_argument("--output-img-dir", default="data/mass_build/png/test_images")
    parser.add_argument("--output-mask-dir", default="data/mass_build/png/test_masks")
